...
Для локальной проверки запустите в папке сайта простой веб-сервер, например
`python3 -m http.server 8000`, и откройте `http://localhost:8000/`.
...
about/index.html        О нас        │ страницы с чистыми адресами,
publications/index.html Публикации   │ вёрстка шапки общая
contacts/index.html     Контакты     ┘
*.html                  переходы со старых адресов на чистые
assets/
